...
public class Doctor {
    ...
    public Doctor(String name, String address, String emailId, String phone, String password, String state, String city, String specialize, int experience, String uidDoctor, int fee, int moneyOwed, int moneyReceived) {
        this.name = name;
